...
happyReduction_27 happy_x_3
	...
	case happyOut12 happy_x_3 of { happy_var_3 -> 
	happyIn12
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ err = (checkEqualType (tip happySubAttrs_1) (tip happySubAttrs_3) ) , envFunOut = (envFunIn happySelfAttrs) , envOut = (envIn happySelfAttrs) , tip = RTypeBool , parsetree = El (parsetree happySubAttrs_1) (parsetree happySubAttrs_3)  }; (happyConditions_1,happySubAttrs_1) = happy_var_1 happyEmptyAttrs{ envIn = (envIn happySelfAttrs)  }; (happyConditions_3,happySubAttrs_3) = happy_var_3 happyEmptyAttrs{ envIn = (envIn happySelfAttrs)  }; happyConditions = [( if ( (err happySelfAttrs) =="") then (Ok()) else ( if ( (tip happySubAttrs_1) ==VarNotDec) then Bad $ (prntErrNotDec (parsetree happySubAttrs_1) ) else ( if ( (tip happySubAttrs_3) ==VarNotDec) then Bad $ (prntErrNotDec (parsetree happySubAttrs_3) ) else Bad $ (prntErrComp happy_var_2 ) ) ) ) ]++happyConditions_1++happyConditions_3 } in (happyConditions,happySelfAttrs)
	)}}}
...
happyReduction_30 happy_x_3
	...
	case happyOut12 happy_x_3 of { happy_var_3 -> 
	happyIn12
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ err = (checkEqualType (tip happySubAttrs_1) (tip happySubAttrs_3) ) , envFunOut = (envFunIn happySelfAttrs) , envOut = (envIn happySelfAttrs) , tip = (tip happySubAttrs_1) , parsetree = Eadd (parsetree happySubAttrs_1) (parsetree happySubAttrs_3)  }; (happyConditions_1,happySubAttrs_1) = happy_var_1 happyEmptyAttrs{ envIn = (envIn happySelfAttrs)  }; (happyConditions_3,happySubAttrs_3) = happy_var_3 happyEmptyAttrs{ envIn = (envIn happySelfAttrs)  }; happyConditions = [( if ( (err happySelfAttrs) =="") then (Ok()) else (Bad $ (prntErrAdd happy_var_2 )) ) ]++happyConditions_1++happyConditions_3 } in (happyConditions,happySelfAttrs)
	)}}}
...
happyReduction_40 happy_x_1
	...
	happyIn12
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ envFunOut = (envFunIn happySelfAttrs) , envOut = (envIn happySelfAttrs) , tip = (tip happySubAttrs_1) , parsetree = Econs (parsetree happySubAttrs_1)  }; (happyConditions_1,happySubAttrs_1) = happy_var_1 happyEmptyAttrs; happyConditions = []++happyConditions_1 } in (happyConditions,happySelfAttrs)
	)}
...
happyReduction_41 happy_x_1
	 =  case happyOut11 happy_x_1 of { happy_var_1 -> 
	happyIn12
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ envFunOut = (envFunIn happySelfAttrs) , envOut = (envOut happySubAttrs_1) , tip = (tip happySubAttrs_1) , parsetree = LExprR (parsetree happySubAttrs_1)  }; (happyConditions_1,happySubAttrs_1) = happy_var_1 happyEmptyAttrs{ envIn = (envIn happySelfAttrs)  }; happyConditions = []++happyConditions_1 } in (happyConditions,happySelfAttrs)
	)}
...
happyReduction_63 (happy_x_5 `HappyStk`
	...
	happyIn22
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ envFunOut = (envFunIn happySelfAttrs) , err = (checkDefVar (parsetree happySubAttrs_3) (tip happySubAttrs_5) ) , envOut = (insVarEnv (Var (parsetree happySubAttrs_1) (tip happySubAttrs_3) ) (envIn happySelfAttrs) ) , parsetree = SBlockVar (parsetree happySubAttrs_1) (parsetree happySubAttrs_3) (parsetree happySubAttrs_5)  }; (happyConditions_1,happySubAttrs_1) = happy_var_1 happyEmptyAttrs; (happyConditions_3,happySubAttrs_3) = happy_var_3 happyEmptyAttrs; (happyConditions_5,happySubAttrs_5) = happy_var_5 happyEmptyAttrs; happyConditions = [( if ( (err happySelfAttrs) =="") then (Ok()) else (Bad $ (prntErrDiffType happy_var_2 )) ) ]++happyConditions_1++happyConditions_3++happyConditions_5 } in (happyConditions,happySelfAttrs)
	) `HappyStk` happyRest}}}}
