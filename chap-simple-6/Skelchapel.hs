...
transLExpr x = case x of
  RLExpr iden  -> failure x


transRExpr :: RExpr -> Result
transRExpr x = case x of
  RAdd rexpr1 rexpr2  -> failure x
  RGre rexpr1 rexpr2  -> failure x
  RDiv rexpr1 rexpr2  -> failure x
  RComp rexpr1 rexpr2  -> failure x
...
transBlockVar x = case x of
  RBlockVar iden type' rexpr  -> failure x
...
transStmtFor x = case x of
  SForDoBloc iden aggr stmts  -> failure x
