...
happyActOffsets = HappyA# "\x0b\x00\x06\x00\x00\x00\x00\x00\xff\xff\x0e\x00\x04\x00\x00\x00\x00\x00\x18\x00\xf5\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x18\x00\x18\x00\x05\x00\x05\x00\x00\x00"#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# "\x24\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x17\x00\x27\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x0c\x00\x01\x00\x00\x00\x00\x00\x00\x00"#

happyDefActions :: HappyAddr
happyDefActions = HappyA# "\xe7\xff\x00\x00\xfe\xff\xf2\xff\x00\x00\xe6\xff\x00\x00\xf9\xff\xfa\xff\x00\x00\xe7\xff\xe5\xff\xf7\xff\xf6\xff\xf5\xff\xf4\xff\xef\xff\xf8\xff\xf3\xff\xed\xff\xee\xff\xfd\xff\xfc\xff\xfb\xff\x00\x00\x00\x00\xf0\xff\xf1\xff"#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happyReduction_19 happy_x_1
	 =  happyIn15
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ parsetree = RTypeInt  }; happyConditions = [] } in (happyConditions,happySelfAttrs)
	)

happyReduce_20 = happySpecReduce_1  11# happyReduction_20
happyReduction_20 happy_x_1
	 =  happyIn15
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ parsetree = RTypeFloat  }; happyConditions = [] } in (happyConditions,happySelfAttrs)
	)

happyReduce_21 = happySpecReduce_1  11# happyReduction_21
happyReduction_21 happy_x_1
	 =  happyIn15
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ parsetree = RTypeChar  }; happyConditions = [] } in (happyConditions,happySelfAttrs)
	)

happyReduce_22 = happySpecReduce_1  11# happyReduction_22
happyReduction_22 happy_x_1
	 =  happyIn15
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ parsetree = RTypeString  }; happyConditions = [] } in (happyConditions,happySelfAttrs)
	)

happyReduce_23 = happySpecReduce_1  11# happyReduction_23
happyReduction_23 happy_x_1
	 =  happyIn15
		 (\happyInhAttrs -> let { happySelfAttrs = happyInhAttrs{ parsetree = RTypeBool  }; happyConditions = [] } in (happyConditions,happySelfAttrs)
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	PT _ (T_Iden happy_dollar_dollar) -> cont 16#;
	_ -> cont 17#;
	_ -> happyError' (tk:tks)
	}
...
data MyAttribute a = HappyAttributes {parsetree :: a, tip :: Type, err :: String, addr :: String}
happyEmptyAttrs = HappyAttributes {parsetree = error "invalid reference to attribute 'parsetree'", tip = error "invalid reference to attribute 'tip'", err = error "invalid reference to attribute 'err'", addr = error "invalid reference to attribute 'addr'"}
